...
def wrapped_parameters(IU):
    ...
    post_processing_calculation(output_data, str(IU), "./model_output/model_output_MTP_" + str(IU) + ".csv", n_runs)
...
path = './model_output/IUs_MTP_proj_' + str(id) + '.csv'
