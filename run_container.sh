...
IMAGE="oncho-amis-pipeline:latest"
CONTAINER_NAME="oncho-amis-pipeline-run-$(date +%s)"
...
CONTAINER_DIRS=(
    "/ntdmc/oncho-amis-integration/fitting-prep/artefacts"
    "/ntdmc/oncho-amis-integration/fitting/artefacts"
    "/ntdmc/oncho-amis-integration/projections-prep/artefacts"
    "/ntdmc/oncho-amis-integration/projections/artefacts"
)
